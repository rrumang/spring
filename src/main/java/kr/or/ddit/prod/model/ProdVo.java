...
public class ProdVo {
	...
	public ProdVo(String prod_id, String prod_name, String prod_lgu, String prod_buyer, String prod_cost,
			String prod_price, String prod_sale, String prod_outline, String prod_detail, String prod_img,
			String prod_totalstock, String prod_insdate, String prod_properstock, String prod_size, String prod_color,
			String prod_delivery, String prod_unit, String prod_qtyin, String prod_qtysale, String prod_mileage) {
		super();
		this.prod_id = prod_id;
		this.prod_name = prod_name;
		this.prod_lgu = prod_lgu;
